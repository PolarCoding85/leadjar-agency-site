...
import HeroBgImage from '../../../../assets/images/bg/1.jpg'
            ...
            <div className="container small-container">
                ...
                <div className="main-search-input-tabs  tabs-act fl-wrap">
                    <ul className="tabs-menu change_bg no-list-style">
                        <li className="current"><a href="#tab-inpt1" data-bgtab={HeroBgImage}> Places</a></li>
                        <li><a href="#tab-inpt2" data-bgtab={HeroBgImage}> Events</a></li>
                        <li><a href="#tab-inpt3" data-bgtab={HeroBgImage}> Restaurants</a></li>
                        <li><a href="#tab-inpt4" data-bgtab={HeroBgImage}> Hotels</a></li>
                    </ul>
                    {/* tabs --> */}
                            ...
                            <div id="tab-inpt1" className="tab-content first-tab">
                                <div className="main-search-input-wrap fl-wrap">
                                    <div className="main-search-input fl-wrap">
                                        ...
                                        <button className="main-search-button color2-bg" onClick={() => { history.push('/listing') }}>Search <i className="far fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
