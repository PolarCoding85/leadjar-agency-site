          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="footer-widget fl-wrap">
                ...
                <div className="footer-contacts-widget fl-wrap">
                  <p>We are on a mission to change the way people and businesses think about taxes. Our goal is to create a safe and fun way to find high quality tax & accounting professionals. All of our listed professionals have been prescreened and vetted.</p>
                  ...
                  <ul className="no-list-style">
                    <li className="clearfix">
                      <a href="#" className="widget-posts-img">
                        <img src={AllIcon} className="respimg" alt="" />
                      </a>
                      <div className="widget-posts-descr">
                        ...
                        <span className="widget-posts-date">
                          <i className="fal fa-calendar"></i> 21 Mar 09.05{" "}
                        </span>
                      </div>
                    </li>
                    <li className="clearfix">
                      ...
                      <div className="widget-posts-descr">
                        ...
                        <span className="widget-posts-date">
                          <i className="fal fa-calendar"></i> 7 Mar 18.21{" "}
                        </span>
                      </div>
                    </li>
                    <li className="clearfix">
                      ...
                      <div className="widget-posts-descr">
                        ...
                        <span className="widget-posts-date">
                          <i className="fal fa-calendar"></i> 7 Mar 16.42{" "}
                        </span>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="col-md-4">
              <div className="footer-widget fl-wrap ">
                ...
                <a href="#" className="footer-link twitter-link" target="_blank">
                  Follow us <i className="fal fa-long-arrow-right"></i>
                </a>
              </div>
            </div>
            {/* footer-widget end--> */}
